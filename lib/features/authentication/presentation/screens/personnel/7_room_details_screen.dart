...
class _RoomDetailsScreenState extends State<RoomDetailsScreen> {
      ...
      setState(() {
        ...
        if (data['features'] is Map<String, dynamic>) {
          ...
          features.forEach((key, value) {
            if (value == true) _selectedFeatures.add(key);
          });
        }
  ...
  Future<void> _goToUpdateScreen() async {
    await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => UpdateRoomStatusScreen(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Room $_roomNumber', style: const TextStyle(fontWeight: FontWeight.bold)),
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Room $_roomNumber', style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                        const SizedBox(height: 8),
                        Text('$_roomType Room', style: const TextStyle(fontSize: 16, color: Colors.black87)),
                        const SizedBox(height: 12),
                        Row(
                          children: [
                            Icon(
                              _availability == "Available" ? Icons.check_circle
                                  : _availability == "Occupied" ? Icons.cancel : Icons.schedule,
                              color: _availability == "Available" ? Colors.green
                                  : _availability == "Occupied" ? Colors.red : Colors.orange,
                            ),
                  ...
                  const Text('View the current room image.', style: TextStyle(fontSize: 12, color: Colors.grey)),
                  const SizedBox(height: 12),
                  Container(
                    height: 200,
                    width: double.infinity,
                  ...
                  Container(
                    ...
                    padding: const EdgeInsets.all(16),
                    decoration: BoxDecoration(
                      color: _availability == "Available" ? Colors.green.shade50
                          : _availability == "Occupied" ? Colors.red.shade50 : Colors.orange.shade50,
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              const SizedBox(height: 8),
                              Text(
                                _roomType == "Single" ? _singleRoomSize : _doubleRoomSize,
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              const SizedBox(height: 10),
                              const Text('Price / Semester', style: TextStyle(fontWeight: FontWeight.bold)),
                              const SizedBox(height: 8),
                              Text(
                  ...
                  _selectedFeatures.isEmpty
                      ? Container(
                          ...
                          padding: const EdgeInsets.all(16),
                          decoration: BoxDecoration(color: Colors.grey.shade100, borderRadius: BorderRadius.circular(12)),
                          child: const Text('No room features have been added.', style: TextStyle(color: Colors.grey)),
                        )
                      : Wrap(
                          spacing: 10,
                          runSpacing: 10,
