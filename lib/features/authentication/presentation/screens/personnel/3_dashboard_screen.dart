...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> pages = [
      _DashboardContent(onNavigateToTab: _onTabSelected),
      const FloorsScreen(),
    ...
    return Scaffold(
      // IndexedStack maintains scroll position and state across tabs
      body: IndexedStack(
        index: _currentIndex,
        children: pages,
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            ListenableBuilder(
              ...
              builder: (context, child) {
                ...
                return GridView.count(
                  ...
                  crossAxisSpacing: 16,
                  mainAxisSpacing: 16,
                  childAspectRatio: 1.3, // Slightly taller cards to prevent text overflow
                  children: [
            ...
            GridView.count(
              ...
              children: [
                // Switches to tab 1 (Rooms / Floors)
                _quickAction('Manage Rooms', Icons.tune, const Color(0xFFDBEAFE), const Color(0xFF2563EB), () => onNavigateToTab(1)),
                // Switches to tab 2 (Payments)
                _quickAction('Payment\nConfirmations', Icons.credit_card, const Color(0xFFFED7AA), const Color(0xFFF97316), () => onNavigateToTab(2)),
                // Switches to tab 3 (Students)
                _quickAction('Reporting\nStudents', Icons.person_add_alt, const Color(0xFFDBEAFE), const Color(0xFF2563EB), () => onNavigateToTab(3)),
                // Pushes separate screen outside main tabs
